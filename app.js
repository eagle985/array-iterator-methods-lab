//console.log("I am so lost these days!");
...
veryOldInventors.push(inventors.filter(inventor => {
...
inventorNames.push(inventors.map(inventor => ({
...
sortedByBirthYear.push(inventors.sort((a, b) => {
    if (a.year > b.year) {
      return 1
    } 
      else {
...
firstLast.push(people.map(famousPerson => {
    return famousPerson.split(", ").reverse().join(" ")
})
)
